...
project_status:
  ...
  ce_to_builder_field_preservation_schema_sync: active_on_branch
...
patches:
  ...
  CE_To_Builder_Field_Preservation:
    ...
    notes:
      ...
      - Builder context schema now admits the protected fields and preservation manifest at the package boundary.
```
...
validation_state:
  ...
  ce_to_builder_field_preservation_check: added
...
CE protected fields must pass CE_TO_BUILDER_FIELD_PRESERVATION_CONTRACT before Builder execution is authorized.
...
```text
Run npm run validate in a checked-out repository or CI for branch fix-ce-builder-field-preservation.
