...
if (check.generated_by_builder === true && check.knowledge_lookup_performed !== true) add('EV4-ASSET-002');
if (check.asset_type === 'svg' && check.compatibility_profile !== 'elementor_safe_svg') add('EV4-ASSET-003');
