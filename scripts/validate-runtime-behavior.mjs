...
function errorsFor(x){
 ...
 if(!x || typeof x !== 'object' || Array.isArray(x)){ fail('EV4-RUNTIME-000','runtime fixture must be an object.'); return e; }
...
for(const f of process.argv.slice(2)){
 ...
 if(f.includes('tests/invalid/') || x?.expected_valid===false){
