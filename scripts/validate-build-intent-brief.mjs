...
const b=raw?.build_intent_brief;
if(!b || typeof b !== 'object' || Array.isArray(b)){
 fail('EV4-BIB-000','Missing build_intent_brief root object.');
} else {
 ...
 const mayNotOverride = Array.isArray(b.may_not_override) ? b.may_not_override : [];
 for(const r of required) if(!mayNotOverride.includes(r)) fail('EV4-BIB-001',`may_not_override must include ${r}.`);
