...
Batch 3 فقط برای `Structural Reference Paradigm Hardening` پیاده‌سازی شد. هدف patch جایگزینی اتکای decisive به متن آزاد در Reference Paradigm Gate با فیلد ساختاری و validator-backed به نام `first_batch_structure_intent` است.
...
- اصلاح Gemini review برای `connector_strategy: "none"` و comparison نرمال‌شده connector با `?? null`.
